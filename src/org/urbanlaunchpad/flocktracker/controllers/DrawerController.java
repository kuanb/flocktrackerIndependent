...
public class DrawerController {
	...
	public DrawerController(Context context,
			QuestionController questionController, Bus eventBus) {
		this.context = context;
		this.drawerView = (DrawerView) ((Activity) context)
				.findViewById(R.id.chapter_drawer_layout);
		...
		actionBarDrawerToggle = new ActionBarDrawerToggle((Activity) context, /*
																			 * host
																			 * Activity
																			 */
		drawerView, R.drawable.ic_drawer, /*
